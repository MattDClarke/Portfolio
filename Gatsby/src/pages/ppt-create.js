      ...
      <ProjectPageStyles>
        ...
        <section>
          <p>
            ...
            would be a cool project to improve the PowerPoint automation
            further. I wanted to make a version that was user friendly for
            English teachers in Korea. The purpose of the application is to make
            creating PowerPoint presentations easier for teachers. It speeds up
            the process of creating PowerPoint presentations that introduce new
            vocabulary.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            They can also create and save their own word list. Once a user has
        ...
        <section>
          ...
          <p>
            ...
            Slide layout defined for each layout type, that is used to position
          ...
          <p>
            ...
            is also a page where I can view signed up users (username and
            authentication type) and delete them if needed. The user list is
        ...
        <section>
          ...
          <p>
            ...
            italicized. The solution makes use of the canvas element to
            ...
            allow it to fit in the PowerPoint slide. The function works ok, the
            fit could be better. I plan to improve it in the future.{' '}
          </p>
          ...
          <p>
            ...
            the dialog was navigated to. The problem was that each modal was
            mounting and unmounting. The solution was surprisingly simple: add
            the <code>keepMounted</code>
        ...
        <section>
          ...
          <p>
            The app is currently just a basic version, the minimum viable
            product (MVP). I plan to add more templates, nicely designed ones
            that can be widely used. The current templates are very basic. I
            also plan to add other image sources such as Google or Bing and GIFs
            from GIPHY.
          </p>
        </section>
      </ProjectPageStyles>
